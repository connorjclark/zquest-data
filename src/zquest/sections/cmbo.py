...
def get_cmbo_field(bytes: Bytes, version: Version, sversion: int) -> F:
  ...
  return F(name='', type='object', arr_len=num_combos, encode_arr_len=encode_arr_len, fields=[
    ...
    F(name='type', type='B' ),
    F(name='csets', type='B' ),
    F(name='_padding', type='2s') if version.zelda_version < 0x193 else None,
    F(name='_padding', type='16s') if version.zelda_version == 0x191 else None,
    ...
    F(name='_padding', type='11s') if version.zelda_version < 0x193 else None,
