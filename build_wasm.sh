...
emcc -o build/wasm/zc.js $OPTIMIZE_FLAGS \
  ...
  lib/fake-allegro.c lib/decode.c third_party/allegro/src/file.c third_party/allegro/src/unicode.c third_party/allegro/src/libc.c third_party/allegro/src/lzss.c third_party/allegro/src/unix/*.c
